...
DECKS = [
    ...
    },
    {
        "name": "검지 호침덱",
        "keywords": "호흡,침잠,검지",
        "description": "삐돈+뤼상 검지 듀오 + 탕루/탕히스 호흡 + 침잠 10인 편성. 먹장구름 조건 충족. 안정적인 15층 등반덱.",
        "identities": [
            ("검파웅 돈키호테", "돈키호테", 1, "에이스", "삐돈. 검지 핵심. 4동 권장."),
            ("뤼미에르 이상", "이상", 1, "에이스", "뤼상. 검지 핵심."),
            ("탕자 홍루", "홍루", 1, "호흡", "탕루. 호흡 수급 핵심."),
            ("탕자 히스클리프", "히스클리프", 1, "호흡", "탕히스. 8번 자리 배치 가능(탕루 파불코 추가)."),
            ("마침표 듀오 1", "이스마엘", 1, "호흡", "마침표 인격. 호흡 5인 조건용."),
            ("마침표 듀오 2", "싱클레어", 1, "호흡", "마침표 인격. 호흡 5인 조건용."),
            ("버이스/정이스", "오티스", 2, "침잠", "버이스 또는 정이스. 정이스가 합은 더 잘침."),
            ("료슈 박사", "료슈", 2, "침잠", "료박사. 침잠 인격. 없으면 우티스/램그렉으로 대체."),
            ("우티스", "오티스", 3, "대체", "료박사 없을때 대체. 침잠 10인 유지 필수."),
            ("램그렉", "그레고르", 3, "대체", "도발로 합 땡겨와서 지령수행 용이. 침잠 10인 유지."),
        ],
        "packs": [
            (1, "공장팩/자동화", "서릿발 발자국(선택)", 2, "관측: 아우성 들고 1층 자동화 가는 방법도 있음"),
            (3, "낙화", "생강꽃(필수), 만화경(선택), 안경기프트", 1, "검지 3명 -> 만화경+안경 -> 생안편 조합"),
            (4, "탄환이 찍은 마침표", "흑염 파이프, 톱니 파편", 1, "포기 불가"),
            (11, "5호선", "화포, 날숨, 가시", 1, ""),
            (12, "3호선", "부화하지 않은 불씨, 경멸의 시선", 1, ""),
            (15, "영겁의 굴레", "", 1, "15층 추천"),
        ],
        "goods": [
            ("생강꽃, 안경 그리고 전해진 편지", 1, "생안편. 3층 낙화팩. 검지 3인 수혜."),
            ("먹장구름", 1, "침잠 10인 조건. 반드시 충족."),
            ("부화하지 않은 불씨", 1, "12층 3호선. 보험."),
            ("화포", 1, "11층 5호선."),
            ("날숨", 1, "11층 5호선."),
            ("서릿발 발자국", 2, "1층 공장팩. 선택적."),
            ("가위", 2, "6번 자리 인격 수혜."),
            ("명경지수", 2, "생존 보험."),
        ],
    },
